...
data:
  ...
  bundledCode: "Traceback (most recent call last):\n  File \"/opt/hostedtoolcache/Python/3.11.4/x64/lib/python3.11/site-packages/onlinejudge_verify/documentation/build.py\"\
    ...
    RuntimeError: bundler is not specified: range_kth_smallest.test.go\n"
  ...
  verifiedWith:
  - lib/waveletmatrix/range_kth_smallest.test.go
documentation_of: range_kth_smallest.test.go
layout: document
redirect_from:
- /verify/range_kth_smallest.test.go
- /verify/range_kth_smallest.test.go.html
