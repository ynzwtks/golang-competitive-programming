...
data:
  ...
  verifiedWith:
  - lib/waveletmatrix/examples/range_kth_smallest.test.go
documentation_of: lib/waveletmatrix/examples/static_range_frequency.test.go
layout: document
redirect_from:
- /verify/lib/waveletmatrix/examples/static_range_frequency.test.go
- /verify/lib/waveletmatrix/examples/static_range_frequency.test.go.html
