...
data:
  ...
  verifiedWith:
  - lib/waveletmatrix/range_kth_smallest.test.go
documentation_of: lib/waveletmatrix/static_range_frequency.test.go
layout: document
redirect_from:
- /verify/lib/waveletmatrix/static_range_frequency.test.go
- /verify/lib/waveletmatrix/static_range_frequency.test.go.html
